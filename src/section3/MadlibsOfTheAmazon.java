...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		// do it...
		JOptionPane.showMessageDialog(null, "Let's play Mad Libs!");
		JOptionPane.showMessageDialog(null,
				"If you find yourself having to cross a piranha-infested river,\n" + " here's how to do it...");
		...
		JOptionPane.showMessageDialog(null, "Piranhas are more " + adjective + " during the day, so cross \n"
				+ "the river at night. Piranhas are attracted \n" +" to fresh " + liquid + " and will most"
		+ " likely take a bite out \n "+"of your " + body + " if you're " + verb + ". Whatever"
		+ " you do,if you \n" +" have an open wound, try to find another way to get \n"
		+ " back to the " + place + ". Good luck!");
